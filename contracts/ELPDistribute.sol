...
contract ELPDistribute is Ownable, Pausable, ReentrancyGuard {
  ...
  using SafeMath for uint256;
    ...
    mapping(address => WithdrawalHistory) public withdrawalHistories;

    struct WithdrawalHistory{
        uint32[] timestamps;
        uint256 beforeDeduct;
        uint256 afterDeduct;
    }
    ...
    constructor(address _inTokenId, address _outTokenId, address _erc1155) public{
    ...
    function deposit() public nonReentrant {
        ...
        erc1155.mint(msg.sender, 10001,1);
    ...
    function withdraw() public nonReentrant{
        ...
        WithdrawalHistory storage wh = withdrawalHistories[msg.sender];

        wh.timestamps.push(safe32(now));
        wh.beforeDeduct = amountBeforePenalty;
        wh.afterDeduct = amountToWithdraw;
    }
    ...
    function emergencyWithdraw() public nonReentrant onlyOwner{
        uint256 contractBalance = outTokenId.balanceOf(address(this));
        outTokenId.transfer(msg.sender, contractBalance);
    }
