...
// Temporary Nature Token with Governance.
contract TNature is Context, IBEP20, Ownable {
    ...
    string private _name = "Temporary Nature Token";
    string private _symbol = "tNature";
